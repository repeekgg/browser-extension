...
export default () => (
  <React.Fragment>
    ...
    <ListItemText
      secondary={
        'If you like our extension and want to buy us a coffee, we appreciate your support. Donators will get a special "FACEIT Enhancer Donator" badge displayed in the match room. Please include a link to your FACEIT profile in your donation to obtain your badge.'
      }
    />
